...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './adjunto.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADJUNTO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ADJUNTO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ADJUNTO actions', async () => {
      const arg = { id: 20184 };
    ...
    it('dispatches UPDATE_ADJUNTO actions', async () => {
      const arg = { id: 20184 };
    ...
    it('dispatches PARTIAL_UPDATE_ADJUNTO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ADJUNTO actions', async () => {
      const arg = 42666;
