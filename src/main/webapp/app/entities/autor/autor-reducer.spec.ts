...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './autor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AUTOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AUTOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AUTOR actions', async () => {
      const arg = { id: 27814 };
    ...
    it('dispatches UPDATE_AUTOR actions', async () => {
      const arg = { id: 27814 };
    ...
    it('dispatches PARTIAL_UPDATE_AUTOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AUTOR actions', async () => {
      const arg = 42666;
