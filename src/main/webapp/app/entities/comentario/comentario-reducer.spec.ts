...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMENTARIO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMENTARIO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMENTARIO actions', async () => {
      const arg = { id: 24142 };
    ...
    it('dispatches UPDATE_COMENTARIO actions', async () => {
      const arg = { id: 24142 };
    ...
    it('dispatches PARTIAL_UPDATE_COMENTARIO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMENTARIO actions', async () => {
      const arg = 42666;
