...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './etiqueta.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ETIQUETA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ETIQUETA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ETIQUETA actions', async () => {
      const arg = { id: 11529 };
    ...
    it('dispatches UPDATE_ETIQUETA actions', async () => {
      const arg = { id: 11529 };
    ...
    it('dispatches PARTIAL_UPDATE_ETIQUETA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ETIQUETA actions', async () => {
      const arg = 42666;
