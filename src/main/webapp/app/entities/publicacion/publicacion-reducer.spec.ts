...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PUBLICACION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PUBLICACION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PUBLICACION actions', async () => {
      const arg = { id: 3546 };
    ...
    it('dispatches UPDATE_PUBLICACION actions', async () => {
      const arg = { id: 3546 };
    ...
    it('dispatches PARTIAL_UPDATE_PUBLICACION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PUBLICACION actions', async () => {
      const arg = 42666;
